            ...
            {requests.map(req => {
              ...
              return (
                <div key={req.id} className="flex items-center gap-3.5 px-4 py-4 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-xs">
                  <button onClick={() => sender?.username && navigate('/profile/' + sender.username)} className="w-12 h-12 rounded-full overflow-hidden bg-burgundy-100 dark:bg-burgundy-900 flex items-center justify-center text-[15px] font-semibold text-burgundy-700 dark:text-burgundy-300 shrink-0">
          ...
          <div className="space-y-2">
            {friends.map(f => (
              <div key={f.id} className="flex items-center gap-3.5 px-4 py-3.5 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-xs hover:border-gray-200 dark:hover:border-gray-700 transition-all">
                <button onClick={() => navigate('/profile/' + f.username)} className="w-11 h-11 rounded-full overflow-hidden bg-burgundy-100 dark:bg-burgundy-900 flex items-center justify-center text-[14px] font-semibold text-burgundy-700 dark:text-burgundy-300 shrink-0">
