...
-- ── RPC: get or create a 1:1 conversation ──
...
begin
  ...
  if conv_id is null then
    ...
    insert into public.conversation_participants (conversation_id, user_id) values (conv_id, auth.uid()), (conv_id, other_user_id);
  end if;
